...
namespace get_snd_dev_names
{
   ...
   {
      public static readonly Dictionary<AcdbDevices, string> FauxDeviceTable = new Dictionary<AcdbDevices, string>
      {
         ...
         [AcdbDevices.SND_DEVICE_OUT_SPEAKER_AND_HEADPHONES_EXTERNAL_1] =
            "SND_DEVICE_OUT_SPEAKER_AND_HEADPHONES_EXTERNAL_1",
         [AcdbDevices.SND_DEVICE_OUT_SPEAKER_AND_HEADPHONES_EXTERNAL_2] =
            "SND_DEVICE_OUT_SPEAKER_AND_HEADPHONES_EXTERNAL_2",
         ...
         [AcdbDevices.SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_HEADPHONES] =
            "SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_HEADPHONES",
         [AcdbDevices.SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_USB_HEADSET] =
            "SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_USB_HEADSET",
         [AcdbDevices.SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_HI_HEADPHONES] =
            "SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_HI_HEADPHONES",
         ...
         [AcdbDevices.SND_DEVICE_IN_UNPROCESSED_USB_HEADSET_MULTI_CHANNEL_MIC] =
            "SND_DEVICE_IN_UNPROCESSED_USB_HEADSET_MULTI_CHANNEL_MIC",
         [AcdbDevices.SND_DEVICE_IN_VOICE_RECOG_USB_HEADSET_MULTI_CHANNEL_MIC] =
            "SND_DEVICE_IN_VOICE_RECOG_USB_HEADSET_MULTI_CHANNEL_MIC",
         [AcdbDevices.SND_DEVICE_IN_USB_HEADSET_MULTI_CHANNEL_MIC_AEC] =
            "SND_DEVICE_IN_USB_HEADSET_MULTI_CHANNEL_MIC_AEC",
