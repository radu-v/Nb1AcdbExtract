...
static char * faux_device_table[SND_DEVICE_MAX] = {
    ...
    [SND_DEVICE_OUT_SPEAKER_AND_HI_HEADPHONES] = "SND_DEVICE_OUT_SPEAKER_AND_HI_HEADPHONES",
    ...
    [SND_DEVICE_OUT_HEADPHONES_VOIP] = "SND_DEVICE_OUT_HEADPHONES_VOIP",
    [SND_DEVICE_OUT_HI_HEADPHONES_VOIP] = "SND_DEVICE_OUT_HI_HEADPHONES_VOIP",
    [SND_DEVICE_OUT_HI_HEADPHONES] = "SND_DEVICE_OUT_HI_HEADPHONES",
    [SND_DEVICE_OUT_HI_HEADPHONES_44_1] = "SND_DEVICE_OUT_HI_HEADPHONES_44_1",
    [SND_DEVICE_OUT_RINGTONE_SPEAKER] = "SND_DEVICE_OUT_RINGTONE_SPEAKER",
    [SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_HEADPHONES] = "SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_HEADPHONES",
    [SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_USB_HEADSET] = "SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_USB_HEADSET",
    [SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_HI_HEADPHONES] = "SND_DEVICE_OUT_RINGTONE_SPEAKER_AND_HI_HEADPHONES",
    [SND_DEVICE_OUT_FQC_VOICE_HANDSET] = "SND_DEVICE_OUT_FQC_VOICE_HANDSET",
    [SND_DEVICE_OUT_HAC_VOICE_HANDSET] = "SND_DEVICE_OUT_HAC_VOICE_HANDSET",
    [SND_DEVICE_OUT_VOICE_TTY_HCO_USB_HEADSET] = "SND_DEVICE_OUT_VOICE_TTY_HCO_USB_HEADSET",
    [SND_DEVICE_OUT_VOICE_TTY_VCO_USB_HEADPHONES] = "SND_DEVICE_OUT_VOICE_TTY_VCO_USB_HEADPHONES",
    [SND_DEVICE_OUT_VOICE_TTY_FULL_USB_HEADSET] = "SND_DEVICE_OUT_VOICE_TTY_FULL_USB_HEADSET",
    ...
    [SND_DEVICE_IN_HANDSET_VOIP_DMIC] = "SND_DEVICE_IN_HANDSET_VOIP_DMIC",
    [SND_DEVICE_IN_HEADSET_VOIP_MIC] = "SND_DEVICE_IN_HEADSET_VOIP_MIC",
    [SND_DEVICE_IN_SPEAKER_VOIP_MIC] = "SND_DEVICE_IN_SPEAKER_VOIP_MIC",
    [SND_DEVICE_IN_VOICE_HEADSET_DMIC] = "SND_DEVICE_IN_VOICE_HEADSET_DMIC",
    [SND_DEVICE_IN_VOICE_HANDSET_MIC_REC] = "SND_DEVICE_IN_VOICE_HANDSET_MIC_REC",
};
